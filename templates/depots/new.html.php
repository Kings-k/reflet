...
<div class="row">
    <div class="col-md-8 mb-4">
        <div class="card shadow">
            <h5 class="card-header">Nouveau dépôt</h5>
            <div class="card-body">
                <form action="/depots/new" method="post">
                    <div class="form-outline my-4">
                        <input type="text" name="name" id="name" class="form-control form-control-lg" required>
                        <label class="form-label select-label" for="name">Nom</label>
                    </div>
                    <div class="form-outline my-4">
                        <textarea class="form-control form-control-lg" name="description" id="description" rows="3"></textarea>
                        <label class="form-label select-label" for="description">Description</label>
                    </div>
                    <div class="d-md-flex flex-md-row-reverse justify-content-md-between">
                        <div class="my-2 mb-md-4 flex-md-grow-1">
