...
<?= $view['slots']->set('action_path', '/dettes/paiements') ?>
...
<div class="row">
    <div class="col-md-12 mb-4">
        ...
        <div id="paiements-dettes" hidden><?= json_encode($paiementsDettes) ?></div>
        <div class="card">
            <div class="card-body">
                <form action="/dettes/paiements" method="POST" class="d-flex justify-content-between">
        ...
        <div class="card shadow-sm my-2">
            <div class="card-body datatable">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php foreach ($paiementsDettes as $key => $paiementDette) : ?>
                        <tr>
                            <td><?= $key + 1 ?></td>
                            <td><?= $paiementDette['datePaye']->format('d M Y') ?></td>
                            <td><?= round($paiementDette['montantPaye'], 2) ?> $</td>
                            <td><?= round($paiementDette['amount'], 2) ?> $</td>
                            <td><?= round($paiementDette['sold'], 2) ?> $</td>
...
<script src="/assets/paiements-dettes.js" defer></script>
<?= $view['slots']->stop() ?>
