...
<div class="row">
    <div class="col-md-8 mb-4">
        <div class="card shadow">
            ...
            <div class="card-body">
                <form action="/categorieclient/new" method="post">
                    ...
                    <div class="d-flex align-items-center mt-4">
                        <input type="checkbox" class="form-check-input mt-0" name="discount" id="discount">
    ...
    <div class="col-md-4">
        ...
        <?php foreach ($latestCategories as $category) : ?>
            <a class="list-group-item list-group-item-action d-flex justify-content-between" href="/categorieclient/<?= $category->getId() ?>">
